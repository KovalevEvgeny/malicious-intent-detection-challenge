...
list_sentences_train = train['text_decoded'].fillna("unknown").values
list_sentences_test = test['text_decoded'].fillna("unknown").values
...
weights_path = "weights_validation/cnn_lstm_gru_addfeat_decoded.h5"
...
subm_path = "submissions_validated/cnn_lstm_gru_addfeat_decoded_{}.csv".format(int(mean_score * 10**7))
