...
from keras.layers import MaxPooling1D, GlobalMaxPool1D, Dense, Input, Embedding, Dropout, CuDNNGRU, CuDNNLSTM, Conv1D, Bidirectional
    ...
    def on_epoch_end(self, epoch, logs={}):
        if epoch % self.interval == 0:
            ...
            if (score > self.max_score):
                ...
                model.save_weights("weights_validation/cnn_lstm_gru_best_weights.h5")
...
for train_index, val_index in kf.split(X_train):
    ...
    model.load_weights("weights_validation/cnn_lstm_gru_best_weights.h5")
...
subm_path = "submissions_validated/cnn_lstm_gru_validated_{}.csv".format(int(cv_score * 10**7))
subm.to_csv(subm_path, index=False)

apply_rules(test, subm_path, output_path='submissions_rules/cnn_lstm_gru_rules.csv')
