...
y_train[[44315, 19742, 28789, 45852, 13403, 49808, 27099, 32656, 12750, 51920, 30892, 30892, 8405, 64654, 58282, 32486, 48195, 62856, 35292, 51076, 55947]] = 1
...
weights_path = "weights_validation/cnn_lstm_gru_feat_dupl.h5"
best_weights_path = "weights_best/cnn_lstm_gru_feat_dupl/"
...
subm_path = "submissions_validated/cnn_lstm_gru_feat_dupl_{}.csv".format(int(mean_score * 10**7))
subm.to_csv(subm_path, index=False)

test_dupl = np.load('test_dupl.npy').item()
for idx in test_dupl:
    subm.at[idx, 'injection'] = test_dupl[idx]
subm.to_csv('submissions_dupl/cnn_lstm_gru_feat_dupl.csv', index=False)
