...
weights_path = "weights_validation/cnn_lstm_gru_2.h5"
...
subm_path = "submissions_validated/cnn_lstm_gru_2_{}.csv".format(int(mean_score * 10**7))
subm.to_csv(subm_path, index=False)

apply_rules(test, subm_path, output_path='submissions_rules/cnn_lstm_gru_2_rules.csv')
