...
weights_path = "weights_validation/cnn_lstm_gru_attention_feat.h5"
best_weights_path = "weights_best/cnn_lstm_gru_attention_feat/"
...
subm_path = "submissions_validated/cnn_lstm_gru_attention_feat_{}.csv".format(int(mean_score * 10**7))
