...
from keras.layers import GlobalMaxPool1D, GlobalAvgPool1D, Dense, Input, Embedding, Dropout, CuDNNGRU, CuDNNLSTM, Conv1D, Bidirectional, concatenate
...
weights_path = "weights_validation/lstm_gru_cnn_attention_feat.h5"
best_weights_path = "weights_best/lstm_gru_cnn_attention_feat/"
...
subm_path = "submissions_validated/lstm_gru_cnn_attention_feat_{}.csv".format(int(mean_score * 10**7))
