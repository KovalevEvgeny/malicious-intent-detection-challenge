...
weights_path = "weights_validation/cnn_lstm_gru_3.h5"
...
def build_model(embed_size=300, dropout=0.2, kernel_initializer='he_uniform', clipvalue=1.0):
...
subm_path = "submissions_validated/cnn_lstm_gru_3_{}.csv".format(int(mean_score * 10**7))
subm.to_csv(subm_path, index=False)

apply_rules(test, subm_path, output_path='submissions_rules/cnn_lstm_gru_3_rules.csv')
