...
weights_path = "weights_validation/cnn_lstm_gru_addlessfeat_new2_diffconv.h5"
best_weights_path = "weights_best/cnn_lstm_gru_addlessfeat_new2_diffconv/"
...
subm_path = "submissions_validated/cnn_lstm_gru_addlessfeat_new2_diffconv_{}.csv".format(int(mean_score * 10**7))
