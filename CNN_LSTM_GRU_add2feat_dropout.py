...
weights_path = "weights_validation/cnn_lstm_gru_add2feat_dropout.h5"
best_weights_path = "weights_best/cnn_lstm_gru_add2feat_dropout/"
...
subm_path = "submissions_validated/cnn_lstm_gru_add2feat_dropout_{}.csv".format(int(mean_score * 10**7))
