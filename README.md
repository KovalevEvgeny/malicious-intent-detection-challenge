...
|-|-|-|-|-|-|-|-|-|-|
|61|10.12|0.9997723|0.0000844|0.9995620|0.9999125|3/15|9:12|[CNN (different kernel shapes) + LSTM + GRU + Simple Features (less) (NEW DATA)](https://github.com/blacKitten13/malicious-intent-detection-challenge/blob/master/CNN_LSTM_GRU_addlessfeat_new2_diffconv.py)|running...|
