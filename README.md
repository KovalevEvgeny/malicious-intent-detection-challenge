...
|-|-|-|-|-|-|-|-|-|
|34|0.9997933|**0.0000790**|**0.9996502**|0.9998798|**0.99985**|1/14|[CNN + LSTM + GRU + Simple Features](https://github.com/blacKitten13/malicious-intent-detection-challenge/blob/master/CNN_LSTM_GRU_addfeat.py)|4:09|
