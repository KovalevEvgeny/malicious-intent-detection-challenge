...
|-|-|-|-|-|-|-|-|-|-|
|28|**0.9997558**|?|?|?|0.99983|[CNN + LSTM + GRU + Attention](https://github.com/blacKitten13/malicious-intent-detection-challenge/blob/master/CNN_LSTM_GRU_Attention.py)|10|3:06|
