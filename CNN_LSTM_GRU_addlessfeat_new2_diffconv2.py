...
weights_path = "weights_validation/cnn_lstm_gru_addlessfeat_new2_diffconv2.h5"
best_weights_path = "weights_best/cnn_lstm_gru_addlessfeat_new2_diffconv2/"
...
def build_model(features, embed_size=300, dropout=0.2, kernel_initializer='he_normal', clipvalue=1.0):
    ...
    x = concatenate([conv3, conv4, conv5], axis=1)
    x = Dropout(dropout)(x)
...
subm_path = "submissions_validated/cnn_lstm_gru_addlessfeat_new2_diffconv2_{}.csv".format(int(mean_score * 10**7))
